...
function updateAutocompleteList(){
  ...
  var json = fs.readFileSync(path.join(appRoot,'public/data/products.json'));
  var arr = Object.keys(JSON.parse(json));
  fs.writeFileSync(path.join(appRoot,'public/data/products_arr.json'),JSON.stringify(arr.sort()));
  });
}
